...
namespace DStarLite
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            DStarLiteclass.RunDStarLite(0, 1, 8, 6, test);
    ...
    class Test : DStarLiteEnvironment
    {
        ...
        public void MoveTo(Coordinates s, Coordinates e)
        {
            time++;
            px = s.x;
            py = s.y;
            Console.WriteLine($"Move {time} from {s.x},{s.y} to {e.x},{e.y} ");
        }
        ...
        public LinkedList<Coordinates> GetObstaclesInVision()
        {
            ...
            l.AddFirst(new Coordinates(2, 3));
            l.AddFirst(new Coordinates(2, 0));
            return l;
        }
    }
}